...
import type { Stack, Container, ContainerStats } from "@hosuto/shared";
    ...
    <div className="blur-panel rounded-xl transition-all duration-200">
      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 overflow-hidden">
          {allPorts.length > 0 && (
            <>
              <Network size={12} className="shrink-0 text-text-muted" />
      ...
      {expanded && (
        <div className="border-t border-border/40 bg-surface/20">
          <ContainerTableInline containers={stack.containers} containerStats={containerStats} />
        </div>
      )}
    </div>
  );
          ...
          return (
            ...
            >
              ...
              <td className="px-4 py-3 truncate">
                <Text size="xs" mono color="muted" truncate>
